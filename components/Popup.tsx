  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div className="p-6 rounded-lg shadow-lg w-[500px] mx-auto space-y-4 flex flex-col items-center">
        ...
        <div className="bg-white p-2  shadow-md flex items-center justify-center w-[460px] h-[36px] rounded-[13.33px]">
          <div className="flex items-center">
            <BellIcon className="h-4 w-4 text-[#E66DFF] mr-2" aria-hidden="true" />
            <p className="text-[#E66DFF] font-bold text-[16px] w-[370px] h-[17px] mb-1.5">
              {message}
            </p>
          </div>
        </div>
        ...
        <div className="bg-white p-4 shadow-md flex flex-col items-center justify-center w-[392px] h-[213px] rounded-[20px]">
          <p className="w-[268px] h-[95px] opacity-100 font-outfit text-[24px] font-bold leading-[26px] text-center text-[#6669FE] mt-4">
            {additionalInfo}
          </p>
